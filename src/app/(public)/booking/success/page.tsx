    ...
    <div className="min-h-screen bg-gray-50 pt-20">
      ...
      <div className="bg-brand-green py-14">
        <div className="max-w-2xl mx-auto px-4 text-center">
          ...
          <div className="mt-4 inline-block bg-white/20 border border-white/30 text-white text-sm font-mono font-bold px-5 py-2.5 rounded-full">
            Booking #{ref}
          </div>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
            ...
            <div className="flex gap-0 sm:gap-4">
              ...
              <div className="flex-1 p-6">
                ...
                <dl className="grid grid-cols-2 gap-x-8 gap-y-3 text-sm">
                  ...
                  <div>
                    <dt className="text-gray-400 text-xs">Amount Paid</dt>
                    <dd className="font-bold text-brand-green text-base">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {[
            ...
            <div
              key={label}
              className={`bg-white rounded-2xl border border-gray-100 shadow-sm p-4 flex flex-col items-center text-center gap-2 ${
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sm:p-8">
          <h3 className="font-display font-bold text-brand-navy text-xl mb-6">
            What Happens Next?
          </h3>
            ...
            {NEXT_STEPS.map((s) => (
              <div key={s.step} className="flex gap-4">
                <div className="w-9 h-9 rounded-full bg-brand-green/10 flex items-center justify-center shrink-0">
                  <span className="text-xs font-bold text-brand-green">{s.step}</span>
                </div>
                <div>
                  <p className="font-semibold text-brand-navy text-sm mb-0.5">{s.title}</p>
        ...
        <div className="text-center space-y-3">
          <Button asChild className="bg-brand-green hover:bg-brand-green/90 text-white font-bold">
            <Link href="/tours">
          ...
          <p className="text-xs text-gray-400">
            Reference #{ref} · Confirmation sent to{" "}
