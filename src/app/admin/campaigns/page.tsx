  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="font-display text-xl font-extrabold text-brand-navy">Campaigns</h2>
          <p className="mt-0.5 text-xs text-gray-400">Landing-page campaigns shown at /campaign/[slug].</p>
        </div>
        {canCreate && (
          <Link href="/admin/campaigns/new" className="flex items-center gap-1.5 rounded-xl bg-brand-green px-4 py-2 text-sm font-bold text-white transition hover:brightness-110">
