// src/components/destinations/DestinationFAQs.tsx
'use client';
...
// Same accordion mechanics as TourDetailsFAQs / BlogPostFAQs.
export function DestinationFAQs({ faqs }: DestinationFAQsProps) {
