// src/components/destinations/DestinationHowToReach.tsx
...
export function DestinationHowToReach({ html }: DestinationHowToReachProps) {
  if (!html) return null;
  const clean = sanitizeHtml(html, SANITIZE_OPTIONS);
  if (!clean.trim()) return null;

  return (
    <section id="how-to-reach" className="rounded-2xl border border-border bg-card p-3 sm:p-6 shadow-soft">
      <h2 className="text-[17px] font-bold">How to Reach</h2>
      <div
