    ...
    <section className="relative overflow-hidden bg-brand-dark">
      ...
      <div className="relative mx-auto max-w-[1300px] px-4 pb-16 pt-24 sm:px-6 sm:pb-24 sm:pt-28">
        ...
        <div className="flex items-center justify-between gap-3">
          <nav
            className="flex min-w-0 items-center gap-2 text-[14px] text-white/80"
            aria-label="Breadcrumb"
          >
            <a href="/" className="shrink-0 transition hover:text-white">
              Home
            </a>
            <span className="shrink-0">›</span>
            <a href="/tours" className="shrink-0 transition hover:text-white">
              Tours
            </a>
            <span className="shrink-0">›</span>
            ...
            >
              ...
              {i === currentImage && (
                <span className="absolute inset-0 grid place-items-center bg-black/30">
                  <span className="grid h-8 w-8 place-items-center rounded-full bg-white/90 text-[12px] text-brand-ink">
                    ▶
                  </span>
                </span>
              )}
