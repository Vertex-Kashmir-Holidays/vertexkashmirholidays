...
export function TourDetailsOverview({ description, chips }: TourDetailsOverviewProps) {
  return (
    ...
    >
      ...
      <p className="mt-3 text-[13.5px] leading-relaxed text-brand-ink/75">
        {description}
      </p>
      <div className="mt-5 flex flex-wrap gap-2.5">
        {chips.map((chip, i) => (
          <motion.span
            key={i}
            className="flex items-center gap-2 rounded-full border border-brand-line bg-brand-page px-4 py-2 text-[12.5px] font-semibold"
