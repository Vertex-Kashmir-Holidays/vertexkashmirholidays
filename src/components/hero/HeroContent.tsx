        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-12 w-full">
          <div className="grid lg:grid-cols-2 gap-10 xl:gap-16 items-center">
            ...
            <div>
              ...
              >
                While the plains{" "}
                <span className="grad-orange">scorch,</span>
              ...
              >
                Curated Kashmir holidays crafted by locals — houseboat stays, meadow
                treks, shikara sunsets. Priced for honest travellers.
              </motion.p>
...
function InquiryCard() {
  ...
  const onSubmit = async (data: FormValues) => {
    try {
      ...
      const payload: Record<string, unknown> = { name: data.name, phone: data.phone, source: "hero" };
    ...
    <div className="relative rounded-2xl overflow-hidden shadow-2xl max-w-md mx-auto lg:mx-0 lg:ml-auto">
      ...
      <div className="relative p-6 sm:p-8">
        ...
        <div className="mb-6">
          ...
          <h2 className="text-white font-bold text-2xl mb-1 h-display">Get a quote in 60 seconds</h2>
