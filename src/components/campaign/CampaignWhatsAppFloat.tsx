// src/components/sections/CampaignWhatsAppFloat.tsx
'use client';

import Link from 'next/link';

export function CampaignWhatsAppFloat() {
  return (
    <Link
      href="#"
      className="fixed bottom-20 right-5 z-50 grid h-[52px] w-[52px] place-items-center rounded-full bg-[hsl(142,70%,45%)] text-white shadow-card transition hover:scale-110 lg:bottom-6"
