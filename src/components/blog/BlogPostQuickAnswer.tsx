...
export function BlogPostQuickAnswer({ html }: BlogPostQuickAnswerProps) {
  ...
  return (
    <div className="mb-6 rounded-2xl border border-border bg-card p-5 shadow-soft">
      <h2 className="text-[16px] font-bold text-foreground">Quick Answer</h2>
      <div
        className="mt-2 text-[16px] leading-relaxed text-foreground/80 [&_a]:font-semibold [&_a]:text-primary [&_a]:underline-offset-2 hover:[&_a]:underline [&_strong]:font-bold [&_strong]:text-foreground [&_ul]:mt-2 [&_ul]:list-disc [&_ul]:space-y-1 [&_ul]:pl-5"
