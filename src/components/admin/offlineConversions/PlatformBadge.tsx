...
export function PlatformBadge({ platform, className }: { platform: OfflineConversionPlatform; className?: string }) {
  return (
    <span className={cn("text-[10px] font-bold px-2 py-0.5 rounded-full whitespace-nowrap", PLATFORM_BADGE_STYLES[platform], className)}>
