      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-card rounded-2xl border border-border shadow-sm p-6 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <Field
                  ...
                  name="siteName"
                  register={register}
                  placeholder="Vertex Kashmir Holidays"
                />
                {errors.siteName && (
              ...
              <Field
                ...
                name="siteTagline"
                register={register}
                placeholder="Discover the Paradise"
              />
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <Field
                ...
                register={register}
                type="email"
                placeholder="hello@vertexkashmir.com"
              />
              <Field
                label="Phone"
                name="sitePhone"
            ...
            <Field
              ...
              register={register}
              textarea
              placeholder="Dal Lake Road, Srinagar, J&K 190001"
            />
          </div>
          ...
          <div className="bg-card rounded-2xl border border-border shadow-sm p-6 space-y-4">
            ...
            <p className="text-[12px] text-muted-foreground -mt-2">
              Official business identity — shown in legal pages, generated PDFs/itineraries, and
              structured SEO data. Separate from the brand name/address above.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <Field
                ...
                name="legalName"
                register={register}
                placeholder="Vertex Kashmir Tour & Travels"
              />
              <Field
                label="Tourism Registration No."
                name="tourismRegNumber"
                register={register}
                placeholder="JKEA00001840"
              />
              <Field
                label="GST Number"
                name="gstNumber"
                register={register}
                placeholder="01AAXFV5134B1ZB"
              />
            </div>
            <Field
              label="Registration Issuing Authority"
              name="tourismRegAuthority"
              register={register}
          ...
          <div className="bg-card rounded-2xl border border-border shadow-sm p-6 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <Field
                ...
                name="googleReviews"
                register={register}
                placeholder="https://g.page/r/... or share link"
              />
              <Field
            ...
            <p className="text-[12px] text-muted-foreground -mt-2">
              The canonical Google Maps/Business Profile listing URL — distinct from the reviews
              link above. Used to connect your website to your existing Business Profile in
          ...
          <div className="bg-card rounded-2xl border border-border shadow-sm p-6 space-y-4">
            ...
            <p className="text-[12px] text-muted-foreground -mt-2">
              ...
              . Requires <code className="rounded bg-muted px-1">GOOGLE_PLACES_API_KEY</code> to be
              set on the server.
            </p>
            <Field
        ...
        <div className="space-y-6">
          ...
          <div className="bg-card rounded-2xl border border-border shadow-sm p-6 space-y-4">
            ...
            />
            <p className="text-[12px] text-muted-foreground -mt-2">
              Comma-separated percentages offered when recording non-cash payments. Leave blank to
              use the defaults (5, 16, 18). GST never applies to cash payments.
            </p>
          </div>
          ...
          <div className="bg-card rounded-2xl border border-border shadow-sm p-6 space-y-4">
            ...
            <p className="text-[12px] text-muted-foreground -mt-2">
              Used when pages have no meta set.
            </p>
            <Field
              label="Default Meta Title"
              name="metaTitle"
              register={register}
              placeholder="Vertex Kashmir Holidays — Premium Kashmir Tours"
            />
            <Field
              ...
              register={register}
              textarea
              placeholder="Discover the paradise of Kashmir..."
            />
            <Field
        ...
        <div className="flex items-center justify-between gap-4">
          <div>
            ...
            <p className="text-[12px] text-muted-foreground mt-0.5">
              Shows a modal popup to visitors after 30 seconds. Once dismissed it won&apos;t
