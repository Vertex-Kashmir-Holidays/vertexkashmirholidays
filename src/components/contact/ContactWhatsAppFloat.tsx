// src/components/sections/ContactWhatsAppFloat.tsx
'use client';
...
export function ContactWhatsAppFloat() {
  return (
    ...
    >
      <span className="rounded-full bg-white px-4 py-2 text-[12px] font-semibold shadow-card">Chat with us</span>
      <motion.span
        className="grid h-14 w-14 place-items-center rounded-full bg-wa text-white shadow-card transition hover:scale-105"
